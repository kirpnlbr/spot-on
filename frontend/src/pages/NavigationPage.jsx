    ...
    return (
        <div class="flex flex-col space-y-4 bg-white">
            ...
            <div class="flex flex-col space-y-2 px-4">
                <div class="rounded-lg bg-gray-100 border border-gray-200 p-4 flex flex-col">
                ...
                <button class="rounded-lg px-3 py-2 bg-blue-700 border border-blue-600 text-white font-medium w-full hover:bg-blue-600">I've Arrived</button>
            </div>
        </div>
    );
}

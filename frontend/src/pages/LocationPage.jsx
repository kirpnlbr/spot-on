        ...
        <div class="min-h-screen px-4 justify-center items-center flex">
            <div class="flex flex-col space-y-5 rounded-xl border p-10 bg-white shadow border-gray-200">
                <div class="flex flex-col space-y-2 items-center">
                    <MapPin class="text-[#068ef1] w-10 h-10" />
                ...
                <div class="flex flex-col space-y-3 items-center">
                    <button onClick={onEnableLocation} class="rounded-xl p-3 bg-[#068ef1] text-white font-medium w-full hover:bg-blue-600">Allow Location Access</button>

                    ...
                    {rows[rowLabel].map(spot => (
                        <div
                            ...
                            className={`
                                ...
                                ${
                                    spot.isOccupied
                                        ? 'bg-gray-300 text-gray-500 cursor-not-allowed' // Style for occupied spots
                                        : 'border-2 border-blue-600 text-blue-600 hover:bg-blue-100 cursor-pointer' // Style for available spots
                                }
